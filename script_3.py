    ...
    <main class="main-content">
        <div class="container">
            ...
            <section id="resultsSection" class="results-section" style="display: none;">
                ...
                <div class="card">
                    <div class="card-header">
                        <h2>🔍 Similar Historical Audits</h2>
...
print("HTML frontend created successfully!")
print("Filename: templates/index.html")